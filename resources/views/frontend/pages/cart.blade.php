								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span>@currency($cart['price']) </span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span class="money">@currency($cart['amount'])</span></td>
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">You Save<span>@currency(Session::get('coupon')['value'])</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>@currency($total_amount)</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>@currency($total_amount)</span></li>
										@endif
									</ul>
